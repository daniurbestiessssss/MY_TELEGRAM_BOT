...
spam_messages = [ 
    ...
    "ولج اسراء رح اجي اجر امج من شعرات عنابتها بنت التنيج اخليج تتندمين عاليوم الي حطيتي بيها على كسج وفركتي على حبوب وجه مصطفى المديس ولج والله احسج تحبيه لان تكدرين تلعبين بديوسه",
